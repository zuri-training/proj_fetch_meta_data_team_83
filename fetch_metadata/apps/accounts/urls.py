...
from .views import CreateUserView,LoginUserView,LogoutUserView,UserResetPasswordView, UserPasswordChangeView #, UpdateUserView, ShowUser, CreateProfileView,UserProfileDetails
